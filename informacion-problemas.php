...
<head>
	...
	<link rel="stylesheet" href="css/estilos-informacion-problemas.css">
	    ...
	    <section class="centro">
		    ...
		    <section class="centro-2">
		        <header class="titulo">  
					<nav>
						<ul>
							<center><p class="centro-2-1">Información de problemas</p></center>
						</ul>
					</nav>
				</header>
				...
				<?php 
					...
					if (isset($_REQUEST['proceso'])){
						...
						if ($proceso == 'email_enviado') {  
							echo '<center><div><a href="http://www.wiksay.com/informacion-problemas.php"><div class="proceso">Excelente. El e-mail se a mandado. Le responderemos lo antes posible.<span> X</span></div></a></div></center>';
						} else if ($proceso == 'email_incorrecto') { 
							echo '<center><div><a href="http://www.wiksay.com/informacion-problemas.php"><div class="proceso1">Lo sentimos. El e-mail introducido no es valido.<span> X</span></div></a></div></center>'; 
						} else {}; 
					}else{};
					// final aviso
				?>
				    <form  action="gestionar-cuentas-php/proceso-informacion-problema-email.php?user=<?php echo utf8_encode($id_user['apodo']);?>&id=<?php echo $id_user['id'] ;?>" method="POST">
						...
						<div><p>Cuéntanos  cual es el problema*</p></div>
